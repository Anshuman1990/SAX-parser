...
public class ExtractXML extends DefaultHandler implements Constants{
	...
	private Delivery deliveryObj = new Delivery();;
	private String Data;
	...
	private int deliveries_count = 0;
...
//							System.out.println("Team Name= "+Data);
							team_name = Data;
						}
...
//							System.out.println("Total="+Data);
					...
					else if(qName.equalsIgnoreCase(Constants.delivery)){
						if(deliveryObj!=null){
//							System.out.println("************************");
//							System.out.println(deliveryObj.toString());
							deliveryObj.setTeamName(team_name);
							deliveriesData.add(deliveryObj);
							deliveryObj = new Delivery();
						}
					}
